-- Chunk 13 - 2026-05-14
-- Purpose: stored procedure for PRD approval. This only marks the PRD
-- document as final. It deliberately does NOT advance projects.status;
-- Chunk 18 advances planning -> ready_to_build when chunks are generated.
--
...
begin
  ...
  -- Mark the PRD as final. Does NOT advance project status.
